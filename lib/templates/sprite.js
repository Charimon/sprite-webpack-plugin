...
function cssTemplate (params) {
  ...
  items.forEach(function saveClass (item) {
    ...
    console.log("*********************HERE CSS " + options.scale)
    console.log("*********************HERE PX " + item.px.width)
    console.log("*********************HERE PX " + item.px.height)
    item.px.total_width = item.px.total_width / options.scale
    item.px.total_height = item.px.total_height / options.scale
    item.px.width = item.px.width / options.scale
    item.px.height = item.px.height / options.scale
